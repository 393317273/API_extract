...
def main():
       json_num = 0
       result_dict = {}
       #print(interface_link11.all_interface_link[1])
       for m1 in range(len(interface_link11.all_interface_link)):
              url = interface_link11.all_interface_link[m1]
              ...
              try:
                     ...
                     continue
       with open("interface_result11.json","w") as f:
