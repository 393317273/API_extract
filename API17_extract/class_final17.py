...
def main():
       json_num = 0
       result_dict = {}
       for m1 in range(len(class_link17.all_class_link)):
              url = class_link17.all_class_link[m1]
              ...
              field_list1 = list()
              p = re.compile('<div class="col-fi(.*?)<div class="block">',re.S)
              ...
              for x1 in range(len(field_list1)):
                     ...
                     #print(field_name[0])
                     Modifier = re.findall(r'rst.+?<code>(.*?)</code></div>',str(field_list1[x1]))
              ...
              for x1 in range(len(menthon_list1)):
                     ...
                     if methon:                 
                            ...
                            dict_method={} 
                     #dict_method={"Methon":methon,"Parameter":(Parameter),"Throw":throw}
              ...
              try:
                     ...
                     continue
       with open(f"class_result//class_result17.json","w") as f:
